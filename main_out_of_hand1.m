...
clear;
clc;
all_data = importdata('data/result_out_of_hand_11.11.csv');       %30
all_data = importdata('data/result_out_of_hand_11.11_big.csv');       %30
...
%     end
    ...
    fprintf('close_result: %.7f,%.7f,%.7f,%.7f,%.7f,%.7f,%.7f\n', end_result_former)
    ...
    fprintf('end_result: %.7f,%.7f,%.7f,%.7f,%.7f,%.7f,%.7f\n', end_result)
    ...
    fprintf('inv_end_result: %.7f,%.7f,%.7f,%.7f,%.7f,%.7f,%.7f\n', end_result_former)
